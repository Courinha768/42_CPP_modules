...
ClapTrap::ClapTrap()
{
	...
	this->ep = 10;
	this->ad = 0;
	std::cout << TRAP_NAME << ": " << "ClapTrap got created through default constructor" << std::endl;
}
...
ClapTrap::ClapTrap(std::string const _name)
{
	...
	this->ep = 10;
	this->ad = 0;
	std::cout << TRAP_NAME << ": " << name << " got created through standard constructor" << std::endl;
}
...
ClapTrap::ClapTrap(const ClapTrap& src)
{
	...
	this->ep = src.ep;
	this->ad = src.ad;
	std::cout << TRAP_NAME << ": " << name << " got created through copy constructor" << std::endl;
}
...
ClapTrap::~ClapTrap()
{
	std::cout << TRAP_NAME << ": " << name << " has been destructed." << std::endl;
}
